...
const InvoiceGenerator: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            alert('Error saving invoice. Is the backend server running?');
        }
    };
    ...
    return (
        <>
            ...
            <div className="sticky bottom-0 left-0 right-0 p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-t border-gray-200 dark:border-gray-700 flex justify-center gap-4 print:hidden">
                <button
                    onClick={handleSave}
                    className="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-transform transform hover:scale-105"
                >
                    Save Invoice
                </button>
                <button
